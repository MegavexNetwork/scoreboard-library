...
public final class PacketAccessors {
  ...
  public static final ConstructorAccessor<?> OBJECTIVE_CONSTRUCTOR = ReflectUtil.findConstructor(PacketAccessors.OBJECTIVE_CLASS);
  public static final ConstructorAccessor<?> DISPLAY_OBJECTIVE_CONSTRUCTOR = ReflectUtil.findConstructor(PacketAccessors.DISPLAY_OBJECTIVE_CLASS);
  public static final ConstructorAccessor<?> SCORE_CONSTRUCTOR = ReflectUtil.findConstructor(PacketAccessors.SCORE_CLASS, String.class);
  ...
  public static final Object SCORE_ACTION_v1_8_CHANGE = SCORE_ACTION_FIELD_1_8 != null ? ReflectUtil.getEnumInstance(SCORE_ACTION_CLASS, "CHANGE") : null;
