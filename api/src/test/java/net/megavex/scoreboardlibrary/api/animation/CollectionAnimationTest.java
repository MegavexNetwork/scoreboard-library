...
import net.megavex.scoreboardlibrary.api.sidebar.animation.FramedSidebarAnimation;
...
class CollectionAnimationTest {
  ...
  void loopTest() {
    ...
    FramedSidebarAnimation<Integer> animation = FramedSidebarAnimation.create(frames);
